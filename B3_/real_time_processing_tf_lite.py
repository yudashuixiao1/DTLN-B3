...
interpreter_2 = tfl.ite.Interpreter(model_path='./pretrained_model/model_2.tflite')
...
audio,fs = sf.read('/home/ljl/projects/DTLN/DTLN_dns_v2/RNS-持续噪声下持续讲话.wav')
...
for idx in range(num_blocks):
    ...
    out_buffer  += np.squeeze(estimated_block) #out_block  stage1: estimated_block stage2: out_block
    # write block to output file
    out_file[idx*block_shift:(idx*block_shift)+block_shift] = out_buffer[:block_shift]
    time_array.append(time.time()-start_time)
    
# write to .wav file 
sf.write('RNS-持续噪声下持续讲话_stage_1.wav', out_file, fs) 
